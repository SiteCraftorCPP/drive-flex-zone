    ...
    return (
        <section id="services" className="py-20 bg-muted/30 relative overflow-hidden">
            ...
            <div className="hidden lg:block absolute inset-0 pointer-events-none z-0">
                ...
                <div className="absolute top-[75%] right-[9%] animate-float" style={{ animationDelay: '0.4s', animationDuration: '4.8s' }}>
                    <div className="relative">
                        <Truck className="w-14 h-14" style={{ color: '#000000' }} />
                        <YandexLogo />
                    </div>
            ...
            <div className="container mx-auto px-4 relative">
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Выберите подходящий формат работы и подключайтесь к Яндекс за несколько минут
                    </p>
                </div>
